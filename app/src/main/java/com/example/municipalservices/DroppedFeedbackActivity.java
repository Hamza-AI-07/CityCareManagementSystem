...
public class DroppedFeedbackActivity extends AppCompatActivity implements SortedComplaintsAdapter.complaintlist {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dropped_feedback);
        list = new ArrayList<>();

        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("Dropped Feedback");
        }
