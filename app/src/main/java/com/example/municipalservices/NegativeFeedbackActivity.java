...
public class NegativeFeedbackActivity extends AppCompatActivity implements SortedComplaintsAdapter.complaintlist {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("Negative Feedback");
        }
