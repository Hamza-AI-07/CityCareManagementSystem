...
public class ClosedComplaintsActivity extends AppCompatActivity implements SortedComplaintsAdapter.complaintlist{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_closed_complaints);


        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            Objects.requireNonNull(getSupportActionBar()).setTitle("Closed Complaints");
        }
        ...
        complaints.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                if(di.getComplainStatus().equalsIgnoreCase("closed") )
                {
                list.add(di);
