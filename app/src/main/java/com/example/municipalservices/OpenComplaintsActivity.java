...
public class OpenComplaintsActivity extends AppCompatActivity implements SortedComplaintsAdapter.complaintlist{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            Objects.requireNonNull(getSupportActionBar()).setTitle("Open Complaints");
        }
        ...
        complaints.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                if(di.getComplainStatus().equalsIgnoreCase("open"))
                {
                list.add(di);
