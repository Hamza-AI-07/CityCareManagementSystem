...
public class PositiveFeedbackActivity extends AppCompatActivity implements SortedComplaintsAdapter.complaintlist {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("Positive Feedback");
        }
